...
var file_IDL_proto_rawDesc = []byte{
	0x0a, 0x09, 0x49, 0x44, 0x4c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f,
...
func file_IDL_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_IDL_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_IDL_proto_msgTypes[1].Exporter = func(v any, i int) any {
